...
function contentSwap()
{
	...
	function eventListeners()
	{
		...
		portfolioMenu.addEventListener("touchend", whenPortfolioClicked);
		artProject.addEventListener("touchend", whenArtProjectsClicked);
		codeProject.addEventListener("touchend", whenCodeProjectsClicked);
		designProject.addEventListener("touchend", whenDesignProjectsClicked);
		artProjectOne.addEventListener("touchend", whenArtProjectOneClicked);
		artProjectOnePage.addEventListener("touchend", whenArtProjectOnePageClicked);
		codeProjectOne.addEventListener("touchend", whenCodeProjectOneClicked);
		codeProjectOnePage.addEventListener("touchend", whenCodeProjectOnePageClicked);
		codeProjectTwo.addEventListener("touchend", whenCodeProjectTwoClicked);
		codeProjectTwoPage.addEventListener("touchend", whenCodeProjectTwoPageClicked);
		codeProjectThree.addEventListener("touchend", whenCodeProjectThreeClicked);
		codeProjectThreePage.addEventListener("touchend", whenCodeProjectThreePageClicked);
		designProjectOne.addEventListener("touchend", whenDesignProjectOneClicked);
		designProjectOnePage.addEventListener("touchend", whenDesignProjectOnePageClicked);
		designProjectTwo.addEventListener("touchend", whenDesignProjectTwoClicked);
		designProjectTwoPage.addEventListener("touchend", whenDesignProjectTwoPageClicked);
	}
